...
from services.context_analyzer import COMMITMENT_KEYWORDS, OWNERSHIP_COMMITMENT_KEYWORDS
...
def evaluate(dataset: Dict[str, Any]) -> Dict[str, Any]:
    ...
    ALL_COMMITMENT_PATTERNS = set(
        list(OWNERSHIP_COMMITMENT_KEYWORDS) + list(COMMITMENT_KEYWORDS)
    )
