...
MEETING_TEMPLATES = [
    {
        ...
        "segments": [
            (
                "Speaker 1",
                "Let's review the sprint. We need to deploy the new auth service by Friday.",
                "Neutral",
            ),
        ...
        "expected_action_items": [
            {
                "task": "deploy the auth service by Friday",
                "owner": "Speaker 2",
                "deadline": "Friday",
            }
        ],
    ...
    },
    {
        ...
        "segments": [
            ...
            (
                "Speaker 2",
                "I will not ship the beta today because of the bug.",
                "Negative",
            ),
            (
                "Speaker 3",
                "Agreed. Let's not delay the bug fix any further.",
                "Neutral",
            ),
        ],
        "expected_action_items": [],
    ...
    },
    {
        ...
        "segments": [
            ...
            (
                "Speaker 2",
                "Wait, no, I am going to handle the API integration.",
                "Neutral",
            ),
            ("Speaker 1", "Okay, then we decided to let you handle it.", "Positive"),
        ],
        "expected_action_items": [
            {"task": "handle the API integration", "owner": "Speaker 2"}
        ],
...
SALES_TEMPLATES = [
    {
        ...
        "segments": [
            (
                "Speaker 1",
                "Our solution integrates smoothly with your stack.",
                "Positive",
            ),
    ...
    },
    {
        ...
        "segments": [
            ...
            (
                "Speaker 2",
                "It looks good, but I'm not the decision maker. I need to run it by colleagues.",
                "Neutral",
            ),
    ...
    },
    {
        ...
        "segments": [
            ...
            (
                "Speaker 2",
                "Honestly, we are just exploring. Not planning to switch this quarter.",
                "Negative",
            ),
            (
                "Speaker 1",
                "Understood. Should I circle back later this year?",
                "Neutral",
            ),
    ...
    },
    {
        ...
        "segments": [
            (
                "Speaker 2",
                "I would be interested if it had more features, but right now it doesn't solve our problem.",
                "Negative",
            ),
...
INTERVIEW_TEMPLATES = [
    {
        ...
        "segments": [
            ...
            (
                "Candidate",
                "I once had a disagreement over a system architecture.",
                "Neutral",
            ),
            (
                "Candidate",
                "We decided to write a design doc, which resolved it.",
                "Positive",
            ),
        ],
        "expected_action_items": [],
...
def generate_file(idx, template, mode, output_dir):
    ...
    with open(
        os.path.join(output_dir, f"{data['id']}.json"), "w", encoding="utf-8"
    ) as f:
