...
from engine.conversation_engine import get_conversation_engine, ConversationState
...
async def run_pipeline():
    ...
    while offset_bytes < len(audio_data):
        ...
        if raw_segments:
            ...
            enriched = await asyncio.get_running_loop().run_in_executor(None, nlp.enrich_transcript, raw_dicts)
            ...
            conversation, _ = engine.process_segments(diarized, conversation, mode="meeting")
