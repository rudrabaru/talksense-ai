...
class BuyingSignalGT(BaseModel):
    signals: List[Literal["interested", "sounds_good", "makes_sense", "ready_to_buy", "other"]]

# 4. Objections
class ObjectionGT(BaseModel):
    objections: List[Literal["pricing", "security", "timing", "authority", "competition", "other"]]

# 5. Objection Handling
class ObjectionHandlingGT(BaseModel):
    handling_status: Dict[str, Literal["ignored", "acknowledged", "addressed", "resolved"]]
