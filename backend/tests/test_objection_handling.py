...
async def test_objections():
    ...
    async with AsyncSessionLocal() as db:
        ...
        await crud.create_session(db, session_id=session_id, mode="sales")
        await db.commit()

        # 2. Add segments
        # Time 0-5: Customer objection 1 (Ignored)
        # Time 10-15: Customer objection 2 (Acknowledged) -> Sales Rep 15-18 (short)
        # Time 20-25: Customer objection 3 (Addressed) -> Sales Rep 25-35 (long,
        # mentions keyword)
        # Time 40-45: Customer objection 4 (Resolved) -> Sales Rep 45-55 -> Customer
        # 60-65 (Buying signal)
        ...
        segments = [
            ...
            # Objection 2: Timeline (Acknowledged, < 10 words) - response at 155s
            {
                ...
                "start_time": 150.0,
                "end_time": 155.0,
                "text": "The timeline is too short.",
            },
            {
                "speaker_id": "Speaker 1",
                "start_time": 155.0,
                "end_time": 158.0,
                "text": "I hear you on timeline.",
            },
            # Objection 3: Security (Addressed, > 10 words, contains keyword "plan") -
            # response at 265s
            {
                "speaker_id": "Speaker 2",
                "start_time": 260.0,
                "end_time": 265.0,
                "text": "I have security concerns.",
            },
            {
                "speaker_id": "Speaker 1",
                "start_time": 265.0,
                "end_time": 275.0,
                "text": "Our security plan is very comprehensive and we offer many features to protect your data.",  # noqa: E501
            },
            # Objection 4: Features (Resolved, followed by buying signal) - response at
            # 385s, bs at 400s
            {
                "speaker_id": "Speaker 2",
                "start_time": 380.0,
                "end_time": 385.0,
                "text": "It lacks reporting features.",
            },
            {
                "speaker_id": "Speaker 1",
                "start_time": 385.0,
                "end_time": 395.0,
                "text": "We have an advanced reporting module coming in Q3.",
            },
            {
                "speaker_id": "Speaker 2",
                "start_time": 400.0,
                "end_time": 405.0,
                "text": "That sounds great, I am ready to buy.",
            },
        ]
        ...
        oh = next(
            (m.metric_value for m in metrics if m.metric_name == "objection_handling"),
            None,
        )
        import json
