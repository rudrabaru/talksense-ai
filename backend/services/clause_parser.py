...
CLAUSE_BOUNDARIES = [
    ...
    "except", "instead", "wait", "actually", 
    "sorry"
]

# Negation and conditional tokens for individual clauses
NEGATION_TOKENS = {
    "not", "never", "no", "cannot", "won't", "wouldn't", "shouldn't", 
    "don't", "doesn't", "isn't", "wasn't", "didn't", "aren't"
}

CONDITIONAL_TOKENS = {
    "if", "unless", "provided that", "assuming", "would", "could", "might", "depending on"
}
